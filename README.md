...
Only change to original repository is in file: /src/utility/WebSockets.cpp .... direkt Link: [WebSockets.cpp](https://github.com/ehorvat1/RemoteDebug/blob/master/src/utility/WebSockets.cpp) .... where line 42 was changed
